...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /*[_BASE] = LAYOUT(
      ...
      KC_CAPS    ,KC_S       ,KC_F       ,KC_H       ,KC_K       ,KC_SCOLON  ,KC_BACKSLASH,KC_UP      ,KC_KP_4    ,KC_KP_PLUS ,\
      KC_LSFT    ,KC_X       ,KC_V       ,KC_N       ,KC_COMMA   ,KC_SLASH   ,KC_ENTER   ,KC_DOWN    ,KC_KP_2    ,KC_KP_ENTER ,\
      KC_LCTL    ,KC_LALT    ,KC_SPACE   ,KC_M       ,KC_RALT    ,KC_RGUI    ,KC_RCTRL   ,KC_RIGHT   ,KC_KP_DOT  ,KC_AUDIO_VOL_UP ,\
